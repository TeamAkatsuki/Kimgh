...
def rank():
    ...
    BOX_RICH_TEXT = MAINFONT.render('포인트 순', True, GRAY)
    ...
    BOX_RICH_1ST_NAME = MAINFONT.render(str(DICERS_rankcal.r_sort()[0]), True, GOLD)
    BOX_RICH_1ST_NAME_RECT = BOX_RICH_1ST_NAME.get_rect(center = [140, 210])
    BOX_RICH_1ST_VALUE = MAINFONT.render((str(DICERS_rankcal.r_sort()[1]) + ' $'), True, GOLD)
    ...
    BOX_RICH_2ND_NAME = MAINFONT.render(str(DICERS_rankcal.r_sort()[2]), True, SILVER)
    BOX_RICH_2ND_NAME_RECT = BOX_RICH_2ND_NAME.get_rect(center = [140, 350])
    BOX_RICH_2ND_VALUE = MAINFONT.render((str(DICERS_rankcal.r_sort()[3]) + ' $'), True, SILVER)
    ...
    BOX_RICH_3RD_NAME = MAINFONT.render(str(DICERS_rankcal.r_sort()[4]), True, PALEBLUE)
    BOX_RICH_3RD_NAME_RECT = BOX_RICH_3RD_NAME.get_rect(center = [140, 490])
    BOX_RICH_3RD_VALUE = MAINFONT.render((str(DICERS_rankcal.r_sort()[5]) + ' $'), True, PALEBLUE)
    ...
    BOX_CLEV_TEXT = MAINFONT.render('포인트 / 라운드 순', True, GRAY)
    ...
    BOX_CLEV_1ST_NAME = MAINFONT.render(str(DICERS_rankcal.c_sort()[0]), True, GOLD)
    BOX_CLEV_1ST_NAME_RECT = BOX_CLEV_1ST_NAME.get_rect(center=[396, 210])
    BOX_CLEV_1ST_VALUE = MAINFONT.render((str(int(DICERS_rankcal.c_sort()[1]))), True, GOLD)
    ...
    BOX_CLEV_2ND_NAME = MAINFONT.render(str(DICERS_rankcal.c_sort()[2]), True, SILVER)
    BOX_CLEV_2ND_NAME_RECT = BOX_CLEV_2ND_NAME.get_rect(center=[396, 350])
    BOX_CLEV_2ND_VALUE = MAINFONT.render((str(int(DICERS_rankcal.c_sort()[3]))), True, SILVER)
    ...
    BOX_CLEV_3RD_NAME = MAINFONT.render(str(DICERS_rankcal.c_sort()[4]), True, PALEBLUE)
    BOX_CLEV_3RD_NAME_RECT = BOX_CLEV_3RD_NAME.get_rect(center=[396, 490])
    BOX_CLEV_3RD_VALUE = MAINFONT.render((str(int(DICERS_rankcal.c_sort()[5]))), True, PALEBLUE)
    ...
    BOX_LONG_TEXT = MAINFONT.render('라운드 순', True, GRAY)
    ...
    BOX_LONG_1ST_NAME = MAINFONT.render(str(DICERS_rankcal.l_sort()[0]), True, GOLD)
    BOX_LONG_1ST_NAME_RECT = BOX_LONG_1ST_NAME.get_rect(center=[652, 210])
    BOX_LONG_1ST_VALUE = MAINFONT.render((str(DICERS_rankcal.l_sort()[1])), True, GOLD)
    ...
    BOX_LONG_2ND_NAME = MAINFONT.render(str(DICERS_rankcal.l_sort()[2]), True, SILVER)
    BOX_LONG_2ND_NAME_RECT = BOX_LONG_2ND_NAME.get_rect(center=[652, 350])
    BOX_LONG_2ND_VALUE = MAINFONT.render((str(DICERS_rankcal.l_sort()[3])), True, SILVER)
    ...
    BOX_LONG_3RD_NAME = MAINFONT.render(str(DICERS_rankcal.l_sort()[4]), True, PALEBLUE)
    BOX_LONG_3RD_NAME_RECT = BOX_LONG_3RD_NAME.get_rect(center=[652, 490])
    BOX_LONG_3RD_VALUE = MAINFONT.render((str(DICERS_rankcal.l_sort()[5])), True, PALEBLUE)
    ...
    # 종료 텍스트
    BTM_SURFACE_OBJ = MAINFONT.render('back to menu', True, PALERED)
    BTM_RECT = BTM_SURFACE_OBJ.get_rect(center=[652, 575])

    RST_SURFACE_OBJ = MAINFONT.render('랭킹 초기화', True, PALERED)
    RST_RECT = RST_SURFACE_OBJ.get_rect(center = [240, 575])
    ...
    while True:
        ...
        SURFACE.blit(BTM_SURFACE_OBJ, BTM_RECT)
        SURFACE.blit(RST_SURFACE_OBJ, RST_RECT)
